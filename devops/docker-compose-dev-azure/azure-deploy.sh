...
resourcename="investment"  # lower case, only
resourcegroup="investment_rg"
...
# git clone https://github.com/apilogicserver/investment.git
# cd investment
...
az group create --name investment_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group investment_rg --sku S1 --is-linux
az container create --resource-group investment_rg --name investment --image apilogicserver/investment:latest --dns-name-label investment --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//investment.westus.azurecontainer.io:5656'
