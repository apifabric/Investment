...
@Component({
  selector: 'PortfolioInvestment-home',
  templateUrl: './PortfolioInvestment-home.component.html',
  styleUrls: ['./PortfolioInvestment-home.component.scss']
})
export class PortfolioInvestmentHomeComponent implements AfterViewInit {
