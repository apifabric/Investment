...
@Component({
  selector: 'InvestmentAnalyse-home',
  templateUrl: './InvestmentAnalyse-home.component.html',
  styleUrls: ['./InvestmentAnalyse-home.component.scss']
})
export class InvestmentAnalyseHomeComponent implements AfterViewInit {
