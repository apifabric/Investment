...
@Component({
  selector: 'SubscriptionPlan-home',
  templateUrl: './SubscriptionPlan-home.component.html',
  styleUrls: ['./SubscriptionPlan-home.component.scss']
})
export class SubscriptionPlanHomeComponent implements AfterViewInit {
