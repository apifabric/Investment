...
@Component({
  selector: 'UserSubscription-home',
  templateUrl: './UserSubscription-home.component.html',
  styleUrls: ['./UserSubscription-home.component.scss']
})
export class UserSubscriptionHomeComponent implements AfterViewInit {
